...
namespace Entidades_Clase11
{
    public class Competencia
    {
        ...
        public static bool operator +(Competencia competencia, VehiculoDeCarrera vehiculo)
        {
            ...
            {
                throw new CompetenciaNoDisponibleException("Competencia incorrecta", "Competencia.cs", "Sobrecarga del +",ex);
            }
        ...
        public static bool operator ==(Competencia competencia, VehiculoDeCarrera vehiculo)
        {
            ...
            {
                throw new CompetenciaNoDisponibleException("El vehiculo no corresponde a la competencia", "Competencia.cs", "Sobrecarga del ==");
            }
            return false;
        }
        public static bool operator !=(Competencia competencia, VehiculoDeCarrera vehiculo)
