...
namespace Ejercicio1_ElViajarEsUnPlacer
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Camion camioncito = new Camion(8, 2, 8, VehiculoTerrestre.Colores.Azul, 5000);
            ...
            Console.WriteLine("--------------");
            Automovil autito = new Automovil(4, 5, 5, VehiculoTerrestre.Colores.Blanco, 3);
